...
public class Dinnercalculator {
	...
	// Define el menú con alimentos y sus precios
	...
	static {
		...
		// Agrega más alimentos al menú si es necesario
	}
	...
	private static MealOrder findMealInMenu(String mealName) {
		for (MealOrder meal : MENU) {
	...
	// Calcula el costo total basado en los alimentos seleccionados y sus cantidades
	private static double calculateTotalCost(List<MealOrder> selectedMeals) {
